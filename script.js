document.addEventListener('DOMContentLoaded', function() {
  ...
  if ('IntersectionObserver' in window) {
    ...
    animatedElements.forEach(function(element) {
      element.classList.add('animated', 'visible', 'in-view');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "משכנתא אונליין משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a125e04e-5505-4309-b6ab-58c99af92f8e',
                    name: data.name || '',
                    email: data.email || '',
